...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBTVcMBVOdN5gKI38Ledemi0Nw3_ibya0I&libraries=places,geometry"></script>
	        ...
	        <div class="container">
	            <nav id="primary-nav" class="row">
	                <div class="col-sm-7 col-xs-12">
	                    <h1 id="brand"><a href="https://smartsavings.today/rfn/1/index3.php" ><img src="img/logo.png" class="img-responsive" /></a></h1>
	                </div>
	                <div class="col-sm-3 col-xs-12">
	                    <div class="wrapper hidden-xs" style="color:gray; padding-top: 10px">
	                        <div class="counter col_fourth">
<!--
	                            <h5 class="count-text ">Potentially Interested People:</h5>
	                            <h3 class="timer count-title" style="margin-top:-10px" id="count-number" data-to="10398" data-speed="1500"></h3>
-->
	                        </div>
	                    </div>
	                </div>
    ...
    <div class="container">
        <div class="secondarybg whitebg">
	       	<form name="apply_form" action="thankyou.php" id="apply_form" class="form-horizontal quiz_form" method="POST">
	                ...
	                <h1 class="header" id="survey_headline" style="text-transform: uppercase; <?php echo $hide; ?>">FIND VERY LOW MORTGAGE RATES IN <span id="statecurrent"></span></h1>
...
<!-- 	                <h1 class="header" id="survey_headline_slide6" style="display: none">HOW MUCH ADDITIONAL CASH WOULD YOU LIKE TO GET BACK?</h1> -->
	                ...
	                <h1 class="header" id="survey_headline" style="display: none">FIND LOW MORTGAGE RATES IN <span id="statecurrent"></span></h1>
...
<!--                                         <button type="button" class="btn btn-success btn-block btn-lg btn-page2" data-value="Coop">Coop</button> -->
                        ...
                        <!-- END STATE_QUESTION -->                        
                            ...
                            <div class="slider-slide" id="calculate_slide">
                                <div class="row">
                                    <div class="col-xs-12" >
                                        <div id="animated6" style="margin-top: 20px; display: none;" ><img src="img/checker.gif" />
                            ...
                            <div class="slider-slide" id="balance_mortgage_value_slider">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12">
                                     <button type="button" id="btn-page62back" class="btn  btn-lg btn-page62-back" ><strong>Back</strong></button> 
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="summary_terms">
                <p style="text-align:center;color:#424242">
                   ...
                   <strong>Copyright 2018 | All Rights Reserved | <a href="https://smartsavings.today/privacy.pdf" target="_blank">Privacy Policy</a> &amp; <a href="https://smartsavings.today/terms.html" target="_blank">Terms</a></strong></p>
