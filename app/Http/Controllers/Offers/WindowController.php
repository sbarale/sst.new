...
class WindowController extends LeadspediaController {
    ...
    public function showForm( $id = 1 ) {
        return view( "fronts.sst.remodeling.window.$id.index", $this->data );
    }

    public function postForm( $id = 1, $custom_fields = [] ) {
        $custom_fields = [
            'windows_count'     => Input::post( 'windows_count', '' ),
        ...
        return view( "fronts.sst.remodeling.window.$id.thankyou", [
