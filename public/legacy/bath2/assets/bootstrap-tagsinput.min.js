...
! function (a) {
    ...
    function b(b, c) {
        this.itemsArray = [], this.$element = a(b), this.$element.hide(), this.isSelect = "SELECT" === b.tagName, this.multiple = this.isSelect && b.hasAttribute("multiple"), this.objectItems = c && c.itemValue, this.placeholderText = b.hasAttribute("placeholder") ? this.$element.attr("placeholder") : "", this.inputSize = "250px" /*Math.max(1,this.placeholderText.length)*/ , this.$container = a('<div class="bootstrap-tagsinput"></div>'), this.$input = a('<input style="width: ' + this.inputSize + '" type="text" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container), this.$element.after(this.$container), this.build(c)
    }
    ...
    b.prototype = {
        ...
        build: function (b) {
            ...
            e.objectItems && (e.options.freeInput = !1), c(e.options, "itemValue"), c(e.options, "itemText"), c(e.options, "tagClass"), e.options.source && (h.source = e.options.source), h.source && a.fn.typeahead && (d(h, "source"), e.$input.typeahead({
                ...
                sorter: function (a) {
                    //return a.sort()
					return (!e.options.sorting) ? a : a.sort(); 
					//return a;
                },
                ...
                switch (b.which) { /*case 8:if(0===f(c[0])){var g=d.prev();g&&e.remove(g.data("item"))}break;*/
                case 46:
                    if (0 === f(c[0])) {
                        var h = d.next();
                ...
                c.attr("style", "width: 250px" /*Math.max(this.inputSize,c.val().length)*/ )
