...
$offer_url = 'https://leads.gotitguy.com/genericPostlead.php?TYPE=95';
...
if (isset($_POST['_submit']) && $_POST['_submit'] == 1) {
    ...
    $address1 = isset($_POST['address']) ? $_POST['address'] : ''; 
     $ad_presell = $_POST['ad_presell'];
        

        $data = array(
            'SRC'=>$src,
            'Landing_Page'=>'savings-scanner.com/roof/',
            'IP_Address'=>$ip,
            ...
            'Repair' => $_POST['replace_repair'],
            'Details' => $_POST['project_detail'],
            'Homeowner' => $_POST['own_home'],
            'Project' => 'Roofing Composition Shingle',
        ...
        <div class="container">
            <nav id="primary-nav" class="row">
                <div class="col-sm-7 col-xs-12">
                    <h1 id="brand"><img src="img/logo1.png" class="img-responsive" /></h1>
                </div>
                ...
                <div class="col-sm-2 col-xs-12">
                    <div class="header_number">
                        <div style="font-size:13px;font-weight:normal;" class="hidden-xs"><img src="img/secure2.png"  />
                            <!--
                            </br>
        ...
        <div class="container ">
            <div class="secondarybg  whitebg">
                <div class="quiz_form ">
                    ...
                    <?php
					echo "<h3><img src='https://savings-scanner.com/chw/1/img/compleet.png'> Roof installation/replacement Step 1 Complete</h3>" ; 
...
// 						fbq('init', '<?php echo $fbid;?>');
 ...
 $random_number =rand(1, 2);
						...
						?>
                   		...
                   		<h3>To download your credit please <u><u><a href="<?php echo $urlupsell; ?>"  style="background-color: #e9ebee; text-decoration: none; color:#424242;  padding: 5px;" >click here now.<a></u></h3>
	                   		
					   	<a href="<?php echo $urlupsell; ?>" ><img src="img/cr.png" style="margin: 0 auto;" class="img-responsive" /><a>
		                    ...
		                    ?>
		                     <h2 style="color:#fff; background-color: #3b5998; padding: 5px;">Important Notice</u></h2>
                   		<h3>During your free evaluation you may need a Fresh Copy of your Credit Report.</h3>
                   		<h3>To download your credit please <u><a href="<?php echo $urlupsell; ?>"  style="background-color: #e9ebee; text-decoration: none; color:#424242;  padding: 5px;" >click here now.<a></u></h3>
